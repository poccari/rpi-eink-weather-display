...
def index():
    ...
    hourly_forecast = mycol.hourly_forecasts_data['data'][0:5]
    daily_forecast = mycol.daily_forecasts_data['data'][1:5]
    weather_warnings = mycol.warnings_data['data']
    return render_template('index.html', last_sync=last_sync, battery_status=battery_status, current_data=current_data, hourly_forecast=hourly_forecast, daily_forecast=daily_forecast, weather_warnings=weather_warnings)
